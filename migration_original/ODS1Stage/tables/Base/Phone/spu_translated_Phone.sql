CREATE OR REPLACE PROCEDURE ODS1_STAGE.BASE.SP_LOAD_PHONE()
    RETURNS STRING
    LANGUAGE SQL
    EXECUTE AS CALLER
    AS  
...
CTE_Swimlane_Phones AS (
    SELECT
        ...
        CASE WHEN S.ProductCode='MAP' THEN NULL ELSE JSON.DISPLAYPARTNER_PHONEPTPMRM END AS PhonePTPSRM,
