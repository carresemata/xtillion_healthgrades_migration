CREATE OR REPLACE MATERIALIZED VIEW ODS1_STAGE_TEAM.RAW.VW_CUSTOMER_PRODUCT_PROFILE AS (
...
SELECT
    ...
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:FEATURE[0].FEATURE_AUTODF) AS Feature_FeatureAutodf,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:FEATURE[0].FEATURE_PTP) AS Feature_FeaturePtp,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:FEATURE[0].FEATURE_AUTODO) AS Feature_FeatureAutodo,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:FEATURE[0].FEATURE_AUTODP) AS Feature_FeatureAutodp,
    ...
    -- Display Partner
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].REF_DISPLAY_PARTNER_CODE) AS DisplayPartner_RefDisplayPartnerCode,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTDES) AS DisplayPartner_PhonePtdes,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTDESM) AS DisplayPartner_PhonePtdesm,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTDEST) AS DisplayPartner_PhonePtdest,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTMTR) AS DisplayPartner_PhonePtmtr,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTMTRM) AS DisplayPartner_PhonePtmtrm,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTMTRT) AS DisplayPartner_PhonePtmtrt,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTMWC) AS DisplayPartner_PhonePtmwc,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTMWCM) AS DisplayPartner_PhonePtmwcm,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTMWCT) AS DisplayPartner_PhonePtmwct,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTPSR) AS DisplayPartner_PhonePtpsr,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTPSRM) AS DisplayPartner_PhonePtpsrm,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTPSRT) AS DisplayPartner_PhonePtPsrt,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTHOS) AS DisplayPartner_PhonePtHos,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTHOSM) AS DisplayPartner_PhonePtHosM,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTHOST) AS DisplayPartner_PhonePtHost,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTPSRD) AS DisplayPartner_PhonePtPsrd,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTEMP) AS DisplayPartner_PhonePtEmp,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTEMPM) AS DisplayPartner_PhonePtEmpM,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTEMPT) AS DisplayPartner_PhonePtEmpt,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTDPPEP) AS DisplayPartner_PhonePtDpPep,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].PHONE_PTDPPNP) AS DisplayPartner_PhonePtDpPnp,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].DATA_SOURCE_CODE) AS DisplayPartner_SourceCode,
    TO_TIMESTAMP_NTZ(Process.CUSTOMER_PRODUCT_PROFILE:DISPLAY_PARTNER[0].UPDATED_DATETIME) AS DisplayPartner_LastUpdateDate,
    
    -- Image
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:IMAGE[0].MEDIA_FILE_NAME) AS Image_MediaFileName,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:IMAGE[0].REF_MEDIA_IMAGE_TYPE_CODE) AS Image_RefMediaImageTypeCode,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:IMAGE[0].REF_MEDIA_SIZE_CODE) AS Image_RefMediaSizeCode,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:IMAGE[0].REF_MEDIA_REVIEW_LEVEL_CODE) AS Image_RefMediaReviewLevelCode,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:IMAGE[0].MEDIA_PATH) AS Image_MediaPath,
    TO_VARCHAR(Process.CUSTOMER_PRODUCT_PROFILE:IMAGE[0].DATA_SOURCE_CODE) AS Image_SourceCode,
