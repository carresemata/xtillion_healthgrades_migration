CREATE OR REPLACE MATERIALIZED VIEW ODS1_STAGE_TEAM.RAW.VW_PROVIDER_PROFILE AS  ( 
...
SELECT
    ...
    -- About Me
    Process.PROVIDER_PROFILE:ABOUT_ME AS AboutMe,
    
    -- Appointment Availability
    Process.PROVIDER_PROFILE:APPOINTMENT_AVAILABILITY AS APPOINTMENTAVAILABILITY,
    
    -- Certification Specialty
    Process.PROVIDER_PROFILE:CERTIFICATION_SPECIALTY AS CERTIFICATION_SPECIALTY,
    ...
    -- Condition
    Process.PROVIDER_PROFILE:CONDITION AS Condition,
...
FROM
    MDM_TEAM.MST.PROVIDER_PROFILE_PROCESSING AS Process);
