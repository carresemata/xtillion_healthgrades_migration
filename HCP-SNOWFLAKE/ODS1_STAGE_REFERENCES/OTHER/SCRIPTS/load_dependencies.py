...
def load_dependencies(sql_server_connector, snowflake_connector, external_dependencies, save_format, output_dir, queue_dir) -> None:
     """
...
dag = DAG(
    ...
    description='DAG to connect external/static dependencies from SQL Server to ODS1_Stage in Snowflake',
    schedule_interval='@daily'
)

ods1_dependencies = PythonOperator(
